...
-- -- LATEX environment vars
-- --
-- -- 
-- do
--   -- Set before vimtex loads
--   vim.g.vimtex_view_method = 'zathura'          -- Wayland-friendly, dbus inverse search
--   vim.g.vimtex_compiler_method = 'latexmk'
--   vim.g.vimtex_fold_enabled = 1                  -- worth it for long docs
--   vim.g.vimtex_quickfix_open_on_warning = 0      -- don't hijack focus on warnings
--   vim.g.vimtex_mappings_prefix = '<localleader>' -- you have localleader = space
--
...
do
  ...
  keymaps = {
    toggle = 'gs',    -- Toggles booleans under the cursor
